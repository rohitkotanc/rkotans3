...
int main(int argc, char* argv[])
{
    ...
    std::string outputFileName = "intermediate-node-car-quadcopter-circular-mobility.json";
    ...
    for (int i = 0; i < numWaypoints; ++i)
    {
        ...
        quadcopterMobility->AddWaypoint(Waypoint(Seconds(timeQuad), Vector(x, y, 10.0)));
