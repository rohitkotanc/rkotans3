...
{
    double durationUser = 115.0;
    std::string outputFileName = "two-car-uav-twenty-building-connectivity.json";
...
Simulator::Schedule(Seconds(96.0), &DropConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(97.0), &RestoreConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(102.0), &DropConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(103.0), &RestoreConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(108.0), &DropConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(109.0), &RestoreConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(114.0), &DropConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(115.0), &RestoreConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(120.0), &DropConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
Simulator::Schedule(Seconds(121.0), &RestoreConnectivity, car1ClientErrorModel, car2ClientErrorModel, serverErrorModel);
...
nodeHelper.Install(nodes.Get(2));
    ...
    building16->SetBoundaries(Box(15.0, 20.0, -91.0, -93.0, 0.0, 45.0));
    building16->SetBuildingType(Building::Residential);
    building16->SetExtWallsType(Building::ConcreteWithWindows);
    building16->SetNFloors(3);
    building16->SetNRoomsX(2);
    building16->SetNRoomsY(2);

    Ptr<Building> building17 = CreateObject<Building>();
    building17->SetBoundaries(Box(15.0, 20.0, -97.0, -99.0, 0.0, 45.0));
    building17->SetBuildingType(Building::Residential);
    building17->SetExtWallsType(Building::ConcreteWithWindows);
    building17->SetNFloors(3);
    building17->SetNRoomsX(2);
    building17->SetNRoomsY(2);

    Ptr<Building> building18 = CreateObject<Building>();
    building18->SetBoundaries(Box(15.0, 20.0, -103.0, -105.0, 0.0, 45.0));
    building18->SetBuildingType(Building::Residential);
    building18->SetExtWallsType(Building::ConcreteWithWindows);
    building18->SetNFloors(3);
    building18->SetNRoomsX(2);
    building18->SetNRoomsY(2);

    Ptr<Building> building19 = CreateObject<Building>();
    building19->SetBoundaries(Box(15.0, 20.0, -109.0, -111.0, 0.0, 45.0));
    building19->SetBuildingType(Building::Residential);
    building19->SetExtWallsType(Building::ConcreteWithWindows);
    building19->SetNFloors(3);
    building19->SetNRoomsX(2);
    building19->SetNRoomsY(2);

    Ptr<Building> building20 = CreateObject<Building>();
    building20->SetBoundaries(Box(15.0, 20.0, -115.0, -117.0, 0.0, 45.0));
    building20->SetBuildingType(Building::Residential);
    building20->SetExtWallsType(Building::ConcreteWithWindows);
    building20->SetNFloors(3);
    building20->SetNRoomsX(2);
    building20->SetNRoomsY(2);
...
buildingContainer.Add(building16);
buildingContainer.Add(building17);
buildingContainer.Add(building18);
buildingContainer.Add(building19);
buildingContainer.Add(building20);
