...
main(int argc, char* argv[])
{
    ...
    std::string outputFileName = "three-node-random-walk.json";
    ...
    clientApp.Get(0u)->TraceConnectWithoutContext(
        "Tx", MakeCallback(&netsimulyzer::ThroughputSink::AddPacket, clientThroughput));
    ...
    serverApp.Get(0u)->TraceConnectWithoutContext(
        "TxWithAddresses", MakeBoundCallback(&WriteServerThroughput, serverThroughput));
