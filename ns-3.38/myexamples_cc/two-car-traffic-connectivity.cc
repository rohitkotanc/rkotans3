...
int main(int argc, char* argv[])
{
    ...
    std::string outputFileName = "two-car-traffic-connectivity.json";
...
Simulator::Schedule(Seconds(25.0), &DropConnectivity, clientErrorModel, serverErrorModel);
    Simulator::Schedule(Seconds(26.0), &RestoreConnectivity, clientErrorModel, serverErrorModel);
