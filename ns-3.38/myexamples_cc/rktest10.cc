...
int main(int argc, char* argv[])
{
    ...
    std::string outputFileName = "rktest10.json";
    ...
    std::vector<std::pair<ns3::netsimulyzer::Color3, ns3::StringValue>> nodeDetails = {
        ...
        std::make_pair(ns3::netsimulyzer::RED_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::BLUE_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::GREEN_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::YELLOW_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::RED_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::BLUE_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::ORANGE_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::WHITE_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::BLACK_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE)),
        std::make_pair(ns3::netsimulyzer::PURPLE_VALUE, ns3::StringValue(netsimulyzer::models::CAR_VALUE))
    };
