...
1. Download a release tarball.  This will unpack to a directory such as ``rohit_ns3``
containing |ns3| and some other programs.  Below is a command-line download using ``wget``,
but a browser download will also work::

  $ wget https://www.nsnam.org/releases/rohit_ns3.tar.bz2
  $ tar xfj rohit_ns3.tar.bz2
  $ cd rohit_ns3/ns-3.38
